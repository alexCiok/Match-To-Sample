#Practice Scenario with even split of L/R correct answers
# -------------------------- Header Parameters --------------------------
...
trial {
      trial_duration = 1; #AC: for practice
      picture {
            text { caption = "+"; };
            x= 0; y = 0;
      };
...
trial {
      trial_duration = 3000; #AC : for Practice
      picture {
            text { caption = "+"; };
            x= 0; y = 0;
      };
...
      sequence[2].assign(int_distr[rand_idx]);  
      
      /*
...
            double trial_num = 1;
      until
            trial_num > parameter_manager.get_int("Practice Trials")
      begin
            trial_num = show_block( prac_cond_array, PRACTICE_TYPE_PRACTICE, 0 );
      end;
      present_instructions( get_lang_item( lang, "Practice Complete Caption" ) );
else
      main_instructions( instructions + " " + get_lang_item( lang, "Practice Caption" ) ); #AC main_instructions( instructions );
end;
